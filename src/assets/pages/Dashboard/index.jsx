      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className='w-full self-center px-4 lg:w-1/2'>
            ...
            <p className='font-medium text-slate-400 mb-10 leading-relaxed'>" I'm Putri Mulyani, a junior Back End & Frontend Developer with great enthusiasm in software development. I love learning new things and am always on the lookout for the best practices in the industry. I have ability in problem solving and ready to contribute to challenging projects. Thank You !!! . "</p>
